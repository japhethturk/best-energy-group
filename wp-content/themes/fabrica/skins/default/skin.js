(function() {
    ...
    function fabrica_skin_post_header_init() {
    ...
    fabrica_add_filter('trx_addons_filter_skills_pie_options', function(opt) {
    ...
    function skin_blogger_controls_title() {
        if (jQuery('body').find('.sc_slider_controls:not(.go)').length > 0) {
            jQuery('body').find('.sc_slider_controls:not(.go)').each(function() {
                ...
                if (pagination_style == 'title') {
                    ...
                    slides.each(function(idx) {
                        ...
                        var title = (slide.data('title') ? slide.data('title') : slide.find('[class*="_item_title"]').text());
    ...
    fabrica_add_filter('trx_addons_filter_slider_init_args', function($param, $init) {
    ...
    function skin_blogger_toggle_filter_add_element() {
        if (jQuery('.content').find(".sc_style_toggle").length > 0) {
            jQuery(" .sc_style_toggle").each(function() {
                var toggle_title = FABRICA_STORAGE['toggle_title'];
                jQuery(this).find('.sc_item_filters').append('<div class="title_wrap"><span class="toggle_title"></span><span class="active_tab"></span></div>');
                jQuery(this).find('.sc_item_filters .sc_item_filters_tabs').wrap('<div class="list_wrap"></div>');
                jQuery(this).find('.sc_item_filters .toggle_title').text(toggle_title);
                jQuery(this).find('span.active_tab').mouseenter(function() {
                    jQuery(this).parents('.sc_item_filters').find('.sc_item_filters_tabs').addClass('active');
                });
                jQuery(this).find('.sc_blogger_filters').mouseleave(function() {
            ...
            jQuery(".sc_blogger_portmodern .sc_blogger_item").each(function() {
                jQuery(this).find(".sc_blogger_item_title").on('click', function() {
                    ...
                    if ($share_items.length > 0) {
                        $share_items.addClass('inited').on('click', '.social_item_popup', function(e) {
                            ...
                            if (url != '') {
                                ...
                                var msg = $self.data('message') ? $self.data('message') : FABRICA_STORAGE['msg_copied'];
                                if (msg) {
    ...
    function fabrica_skin_audio_init() {
    ...
    jQuery(window).load(function() {
        fabrica_skin_audio_init();
        skin_add_custom_width_filter_list();
        background_image_portfolio_stretch();
        fabrica_skin_post_header_init();
    });
    jQuery(document).on('action.ready_fabrica', function() {
        ...
        jQuery('.tribe-events-view').on('beforeAjaxComplete.tribeEvents beforeAjaxSuccess.tribeEvents beforeAjaxError.tribeEvents', fabrica_tribe_events_after_ajax);

        function fabrica_tribe_events_after_ajax(jqXHR, textStatus) {
            setTimeout(function() {
                jQuery('.tribe-events-view').on('beforeAjaxComplete.tribeEvents beforeAjaxSuccess.tribeEvents beforeAjaxError.tribeEvents', fabrica_tribe_events_after_ajax);
            }, 10);
        }
        ...
        function mc4wpGO(form) {
            jQuery(form).each(function() {
                ...
                btn.on('click', function(e) {
                    ...
                    var rez = fabrica_form_validate(form, {
                        ...
                        rules: [{
                            ...
                            min_length: {
                                value: 7,
                                message: FABRICA_STORAGE['mc4wp_msg_email_min']
                            },
                            max_length: {
                                value: 60,
                                message: FABRICA_STORAGE['mc4wp_msg_email_max']
                            },
                            mask: {
        ...
        fabrica_add_filter('fabrica_filter_mobile_menu_close_timeout', function(timeout, $menu) {
            return 1000;
        });
        ...
        function fabrica_skin_open_panel(id) {
        ...
        jQuery('.trx_addons_panel_menu_link:not(.panel_inited)').addClass('panel_inited').on('click', function(e) {
            fabrica_skin_open_panel(jQuery(this).attr('href').substring(1));
            e.preventDefault();
            return false;
        });

        function fabrica_skin_close_panel() {
        ...
        $document.on('keyup', function(e) {
            ...
            if (e.keyCode === 27) {
                if ($panel.length === 1) {
                    fabrica_skin_close_panel();
                    e.preventDefault();
                    return false;
                }
            }
        });
        jQuery('.sc_layouts_panel_menu_close, .sc_layouts_panel_menu_overlay').on('click', function(e) {
            fabrica_skin_close_panel();
            e.preventDefault();
            return false;
        });
        jQuery('.sc_layouts_panel_menu_close').on('keyup', function(e) {
            var $panel = jQuery('.sc_layouts_panel_menu.opened');
            if (e.keyCode === 13) {
                if ($panel.length === 1) {
                    fabrica_skin_close_panel();
        ...
        jQuery($search_wrap.each(function() {
            ...
            search_field.on('keyup', function(e) {
                if (e.keyCode === 27) {
                    ...
                    setTimeout(function() {
                        fabrica_search_close($search_wrap_init);
            ...
            $search_wrap_init.find('.search_close').add($search_wrap_init.next('.search_overlay')).on('click', function(e) {
                $body.addClass('search_out_anim');
                setTimeout(function() {
                    fabrica_search_close($search_wrap_init);
                    $body.removeClass('search_open_anim');
    ...
    function fabrica_search_close($search_wrap_init) {
    ...
    jQuery(document).on('action.scroll_fabrica', function() {});
    jQuery(document).on('action.resize_fabrica', function() {
        extra_margin_top_video_popup_button();
        fabrica_skin_post_header_init();
        skin_add_custom_width_filter_list();
    });
    ...
    jQuery('.fabrica_woocommerce_filters_button,.sidebar > .sidebar_close,.sidebar_overlay').on('click', function(e) {
