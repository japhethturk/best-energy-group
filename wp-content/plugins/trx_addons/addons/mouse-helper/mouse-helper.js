        ...
        if (TRX_ADDONS_STORAGE['mouse_helper'] > 0 && $mouse_helper.length > 0 && requestAnimationFrame) {
            ...
            $document.on('mousemove pointermove', function(e) {
                ...
                if (trx_addons_window_width() >= TRX_ADDONS_STORAGE['mobile_breakpoint_mousehelper_off']) {
                    ...
                    var pos = (TRX_ADDONS_STORAGE['mouse_helper_centered'] > 0 && ($self.data("mouse-helper-centered") === undefined || $self.data("mouse-helper-centered") === '')) || $self.data("mouse-helper-centered") > 0 || '';
                    ...
                    if (img) {
                        $mouse_helper.eq(0).find('.trx_addons_mouse_helper_image').remove();
                        $mouse_helper.eq(0).append('<span class="trx_addons_mouse_helper_image" style="background-image:url(' + img + ');"></span>').addClass("trx_addons_mouse_helper_with_image");
                    }
                    var icon = $self.data("mouse-helper-icon") || '';
                    if (icon && icon != 'none') {
                        var icon_color = $self.data("mouse-helper-icon-color") || '',
                            icon_size = $self.data("mouse-helper-icon-size") || '';
                        $mouse_helper.eq(0).find('.trx_addons_mouse_helper_icon').remove().end().append('<span class="trx_addons_mouse_helper_icon ' + icon + '"' +
                            ' style="' +
                    ...
                    if (text) {
                        $mouse_helper.eq(0).find('.trx_addons_mouse_helper_text').remove().end().append('<span class="trx_addons_mouse_helper_text' + (text_round ? ' trx_addons_mouse_helper_text_round' : '') + '"' +
                    ...
                    if (layout) {
                        $mouse_helper.eq(0).find('.trx_addons_mouse_helper_layout').remove().end().append('<span class="trx_addons_mouse_helper_layout">' + layout + '</span>').addClass('trx_addons_mouse_helper_with_layout');
                    }
            ...
            var mouse_helper_links = trx_addons_apply_filters('trx_addons_filter_mouse_helper_links', 'a,button,input[type="button"],input[type="submit"],input[type="reset"]');
            $document.on("mouseenter", mouse_helper_links, function(e) {
            ...
            var mouse_helper_reset = function() {
                ...
                }, $mouse_helper.eq(0).hasClass('trx_addons_mouse_helper_with_icon') || $mouse_helper.eq(0).hasClass('trx_addons_mouse_helper_with_text') || $mouse_helper.eq(0).hasClass('trx_addons_mouse_helper_with_image') || $mouse_helper.eq(0).hasClass('trx_addons_mouse_helper_with_layout') || (mouse_helper_target && (mouse_helper_target.data('mouse-helper-icon') || mouse_helper_target.data('mouse-helper-text') || mouse_helper_target.data('mouse-helper-image') || mouse_helper_target.data('mouse-helper-layout'))) ? (mouse_helper_smooth ? 500 : 0) : (mouse_helper_smooth ? 50 : 0));
                $mouse_helper.eq(0).attr('class', trx_addons_chg_class_by_prefix($mouse_helper.attr('class'), 'trx_addons_mouse_helper_over_element_', ''));
                ...
                if ($inner_elements.length > 0) {
                    if (true) {
                        ...
                        $inner_elements.addClass('trx_addons_mouse_helper_reset_item').animate({
                            opacity: 0,
                            height: 0,
                            width: 0
                        }, mouse_helper_smooth ? 500 : 0, function() {
                            var $self = jQuery(this);
                ...
                $mouse_helper.removeClass('trx_addons_mouse_helper_active' +
                    ...
                    ' trx_addons_mouse_helper_with_layout').toggleClass('trx_addons_mouse_helper_centered', TRX_ADDONS_STORAGE['mouse_helper_centered'] > 0);
                $mouse_helper.each(function(idx) {
                ...
                $mouse_helper_magnets.each(function() {
                    ...
                    function move_item() {
                        ...
                        function transform_item() {
                            ...
                            nx += (d.x - dx) / 5;
                            ny += (d.y - dy) / 5;
                            nx.toFixed(2) !== dx.toFixed(2) && inner.css({
                                'transition': 'none',
