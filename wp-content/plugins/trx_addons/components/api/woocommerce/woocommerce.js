(function() {
    ...
    $document.on('action.ready_trx_addons', function() {
        ...
        function trx_addons_woocommerce_add_to_cart_ajax(type) {
            ...
            if ($bt.length) {
                $bt.addClass('add_to_cart_button ajax_add_to_cart').attr('data-product_id', $bt.attr('value'));
            }
        }
        ...
        function trx_addons_woocommerce_check_variations(form) {
            form.find('.variations select').each(function() {
                var select_box = jQuery(this),
                    ...
                    attrib_box = select_box.siblings('.trx_addons_attrib_extended').length == 1 ? select_box.siblings('.trx_addons_attrib_extended') : select_box.parent().siblings('.trx_addons_attrib_extended');
                attrib_box.find('.trx_addons_attrib_item').removeClass('trx_addons_attrib_selected').addClass('trx_addons_attrib_disabled');
                select_box.find('option').each(function() {
                    var opt = jQuery(this);
                    attrib_box.find('.trx_addons_attrib_item[data-value="' + opt.val() + '"]').removeClass('trx_addons_attrib_disabled').toggleClass('trx_addons_attrib_selected', opt.val() == select_val);
                });
            });
        }
        if (true || $body.hasClass('woocommerce') && $body.hasClass('archive')) {
            $document.on('action.init_hidden_elements', function(e, cont) {
                ...
                cont.find('.trx_addons_product_attribute_item_action_filter:not(.attribute_action_filter_inited)').addClass('attribute_action_filter_inited').on('click', function(e) {
                    var flt = jQuery(this),
                        item = flt.parent(),
                        type = item.data('type'),
                ...
                var $swap_atts = cont.find('.trx_addons_product_attribute_item_action_swap:not(.attribute_action_swap_inited)').addClass('attribute_action_swap_inited');
                if ($swap_atts.length) {
                    $swap_atts.on('click', function(e) {
                        ...
                        if (!disabled) {
                            $item.parents('.trx_addons_product_attribute').find('.trx_addons_product_attribute_item_active').removeClass('trx_addons_product_attribute_item_active');
                ...
                cont.find('.trx_addons_product_attributes[data-product-variations] .trx_addons_product_attribute_item:not(.attribute_action_swap_inited)').addClass('attribute_action_swap_inited').on('focus mouseover', function(e) {
                    var $self = jQuery(this);
                ...
                function swap_product_image($flt) {
                    ...
                    if (variations) {
                        var $active_items = $wrap.find('.trx_addons_product_attribute_item_action_swap').length ? $wrap.find('.trx_addons_product_attribute_item_active') : $flt;
                        $active_items.each(function(idx) {
                            variation_sel[$active_items.eq(idx).data('attribute')] = $active_items.eq(idx).data('value');
                            variation_sel_count++;
                        });
        ...
        var reopen_after_reload = trx_addons_apply_filters('trx_addons_filter_reopen_filter_after_reload_products', false),
            ...
            list_products_loading_selector = trx_addons_apply_filters('trx_addons_filter_reload_products_loading_wrap_selector', '.list_products .products,.list_products .woocommerce-info'),
            list_products_loading_html = trx_addons_apply_filters('trx_addons_filter_reload_products_loading_html', '<div class="trx_addons_loading"></div>'),
        ...
        $document.on('action.init_hidden_elements', function() {
            ...
            if (search_forms.length) {
                search_forms.each(function() {
                    var form = jQuery(this).addClass('inited'),
                        ...
                        type = widget.hasClass('trx_addons_woocommerce_search_type_filter') ? 'filter' : (widget.hasClass('trx_addons_woocommerce_search_type_form') ? 'form' : 'inline'),
                    ...
                    form.on('submit', function(e) {
                        ...
                        jQuery(this).parent('.trx_addons_woocommerce_search_form_field').siblings('.trx_addons_woocommerce_search_form_field').find('.trx_addons_woocommerce_search_form_field_list').slideUp();
                        ...
                        if (type == 'filter') {
                            ...
                            if ($self.parents('.trx_addons_woocommerce_tools').length !== 0 && $self.parents('.trx_addons_woocommerce_search_form_fields_wrap_opened').length === 0) {
                                $self.parents('.trx_addons_woocommerce_search_form_fields_wrap').find('.sc_form_field_opened').each(function() {
                                    ...
                                    if (need_apply) {
                                        ...
                                        trx_addons_woocommerce_search_form_close_field(cur_field);
                                    }
                                });
                            } else if (opened) {
                                ...
                                if (false && need_apply) {
                                    ...
                                    trx_addons_woocommerce_search_form_close_field(field);
                                }
                            }
                            if (!opened) {
                        ...
                        if (type == 'filter' && $self.attr('name') != 'product_cat' && (fields_wrap.hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened') || (fields_wrap.parents('.sidebar').length && (apply || ajax)))) {
                        ...
                        if (type == 'filter' && reload_is_allowed) {
                            ...
                            } else if (!apply && !$self.parents('.trx_addons_woocommerce_search_form_fields_wrap').hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened') && (['price', 's'].indexOf($self.attr('name')) == -1 || $self.parents('.sidebar').length)) {
                        ...
                        if (type == 'filter') {
                            ...
                            if (!$self.attr('disabled')) {
                                if (!$self.parents('.trx_addons_woocommerce_search_form_fields_wrap').hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened') && $self.parents('.sidebar').length === 0) {
                        ...
                        function(e) {
                            ...
                            if ($self.hasClass('trx_addons_woocommerce_search_button_filters') && !wrap.hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened')) {
                                ...
                                if (wrap.hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened') || ($self.parents('.sidebar').length && $self.parents('.trx_addons_woocommerce_search').hasClass('trx_addons_woocommerce_search_apply'))) {
                                    if (wrap.data('param-changed') > 0) {
                                        var last_apply = last_opened_filter ? form.find('input[name="' + last_opened_filter + '"]').parents('.sc_form_field').find('.trx_addons_search_apply:not([disabled])') : false;
                    ...
                    form.find('.trx_addons_woocommerce_search_form_fields_wrap').toggleClass('trx_addons_woocommerce_search_form_fields_filled', form.find('.sc_form_field:not(.sc_form_field_product_cat) .sc_form_field_title_filled').length > 0);
                    ...
                    function trx_addons_woocommerce_search_form_reload_products(form, filter, selector, force_reload_page) {
                        ...
                        if (params !== false) {
                            if (filter && (!ajax || apply || force_reload_page) && filter.parents('.trx_addons_woocommerce_tools').length !== 0 && filter.parents('.trx_addons_woocommerce_search_form_fields_wrap_opened').length === 0) {
                            ...
                            if (ajax && !force_reload_page) {
                                ...
                                jQuery(list_products_loading_selector).addClass('trx_addons_woocommerce_search_loading').append(list_products_loading_html);
                                window.location.href = shop_url;
                            }
                        }
                    }
                    var trx_addons_woocommerce_search_form_reload_products_after_timeout = trx_addons_throttle(trx_addons_woocommerce_search_form_reload_products, trx_addons_apply_filters('trx_addons_filter_reload_products_timeout', ajax ? 500 : 0), true);
                    var trx_addons_woocommerce_search_form_update_available_products_counter = trx_addons_throttle(function(form) {
                    ...
                    }, trx_addons_apply_filters('trx_addons_filter_update_products_counter_timeout', 500), true);
                });
            }
            jQuery('.widget_layered_nav_filters:not(.trx_addons_woocommerce_search_compatibility_inited)').each(function() {
                ...
                if (widget_search.length && widget_search.find('.trx_addons_woocommerce_search_ajax').length && widget_search.find('.sc_form_field_rating').length === 0) {
            ...
            function trx_addons_woocommerce_search_form_open_field(field, open_style, need_focus) {
                ...
                var open_time = open_style == 'show' ? 0 : trx_addons_apply_filters('trx_addons_filter_woocommerce_filter_show_time', field.parents('.trx_addons_woocommerce_tools').length === 0 || field.parents('.trx_addons_woocommerce_search_form_fields_wrap_opened').length > 0 ? 300 : 0);
            ...
            function trx_addons_woocommerce_search_form_close_field(field, restore_value, close_style) {
                ...
                var close_time = close_style == 'hide' ? 0 : trx_addons_apply_filters('trx_addons_filter_woocommerce_filter_show_time', field.parents('.trx_addons_woocommerce_tools').length === 0 || field.parents('.trx_addons_woocommerce_search_form_fields_wrap_opened').length > 0 ? 300 : 0);
            ...
            function trx_addons_woocommerce_search_form_restore_field_view(field) {
                ...
                if (field.hasClass('sc_form_field_select') || field.hasClass('sc_form_field_image') || field.hasClass('sc_form_field_color') || field.hasClass('sc_form_field_button')) {
            ...
            function trx_addons_woocommerce_search_form_param_changed(param) {
                var value = param.val(),
                    ...
                    selected = title.find('.sc_form_field_selected_items'),
                ...
                if (selected.length && (wrap.parents('.trx_addons_woocommerce_tools').length === 0 || fields_wrap.hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened'))) {
                    var value_to_show = '',
                        parts = ('' + value).split(','),
                        $item = null;
                    for (var i = 0; i < parts.length; i++) {
                ...
                fields_wrap.parents('form').find('.trx_addons_woocommerce_search_button_filters_total').html(filters_total).toggleClass('trx_addons_woocommerce_search_button_filters_total_empty', filters_total === 0);
            ...
            function trx_addons_woocommerce_search_form_get_products_from_url(shop_url, fields_wrap) {
                ...
                if (!list_products_loading) {
                    jQuery(list_products_loading_selector).addClass('trx_addons_woocommerce_search_loading').append(list_products_loading_html).find('>' + list_products_loading_class).addClass('trx_addons_hidden').fadeIn(200);
                }
                ...
                jQuery.get(shop_url).done(function(response) {
                    ...
                    if (list_products_loading) {
                        ...
                        jQuery(list_products_loading_selector).find('>' + list_products_loading_class).fadeOut(200, function() {
                    ...
                    function list_products_replace(remove_loading) {
                        ...
                        if (new_products) {
                            ...
                            if (inline_css_wrap.length) {
                                ...
                                if (new_inline_css) {
                                    var new_inline_block_start = new_inline_css.indexOf(inline_css_start),
                                        ...
                                        new_inline_block = new_inline_block_start >= 0 ? new_inline_css.substring(new_inline_block_start, new_inline_block_end + inline_css_end.length) : '';
                                    if (new_inline_block) {
                            ...
                            if (!remove_loading) {
                                jQuery(list_products_loading_selector).toggleClass('trx_addons_woocommerce_search_loading', true).append(list_products_loading_html);
                            }
                            jQuery('.trx_addons_woocommerce_search_button_show_total').text(new_total);
                            jQuery(document).trigger('action.got_ajax_response', {
                                action: 'woocommerce_ajax_get_posts',
                                result: response,
                                products: list_products_wrap.hasClass('products') ? list_products_wrap : list_products_wrap.find('ul.products')
                            });
                        ...
                        if (remove_loading) {
                            jQuery(list_products_loading_selector).removeClass('trx_addons_woocommerce_search_loading').find('>' + list_products_loading_class).remove();
                        }
                        if (widget_number) {
        ...
        var trx_addons_woocommerce_search_form_click_outside = trx_addons_throttle(function() {
            ...
            if (opened.length) {
                ...
                if (fields_wrap.parents('.trx_addons_woocommerce_tools').length && !fields_wrap.hasClass('trx_addons_woocommerce_search_form_fields_wrap_opened')) {
                    opened.find('.sc_form_field_title').trigger('click');
                } else {
                    fields_wrap.find('.trx_addons_woocommerce_search_button_show').trigger('click');
                }
            }
        }, trx_addons_apply_filters('trx_addons_filter_woocommerce_search_click_outside_timeout', 10), true);
        $document.on('click', function(e) {
            var $self = jQuery(e.target);
            if (!$self.hasClass('sc_form_field_wrap') && $self.parents('.sc_form_field_wrap').length === 0 && $self.parents('.trx_addons_woocommerce_search_form_fields_wrap').length === 0 && !$self.hasClass(list_products_loading_class)) {
